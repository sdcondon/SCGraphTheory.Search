...
namespace SCGraphTheory.Search.Classic
{
    ...
    public class DijkstraSearchWithNonNumericCost<TNode, TEdge, TCost> : ISearch<TNode, TEdge>
        ...
        where TCost : IComparable<TCost>, IComparisonOperators<TCost, TCost, bool>, IAdditionOperators<TCost, TCost, TCost>, IAdditiveIdentity<TCost, TCost>
  {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DijkstraSearchWithNonNumericCost{TNode, TEdge, TCost}"/> class.
        /// </summary>
        ...
        public DijkstraSearchWithNonNumericCost(TNode source, Predicate<TNode> isTarget, Func<TEdge, TCost> getEdgeCost)
        {
