...
namespace SCGraphTheory.Search.Classic
{
        ...
        where TCost : INumber<TCost>
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="DijkstraAsyncSearch{TNode, TEdge, TCost}"/> class.
        /// </summary>
        ...
        protected DijkstraAsyncSearch(Func<TNode, ValueTask<bool>> isTargetAsync, Func<TEdge, ValueTask<TCost>> getEdgeCostAsync)
        {
