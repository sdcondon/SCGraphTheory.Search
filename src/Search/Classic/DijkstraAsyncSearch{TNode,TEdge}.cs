...
{
    /// <summary>
    /// Implementation of <see cref="IAsyncSearch{TNode, TEdge}"/> that uses Dijkstra's algorithm (and float-valued costs).
    /// </summary>
    ...
    public class DijkstraAsyncSearch<TNode, TEdge> : IAsyncSearch<TNode, TEdge>
        ...
        where TEdge : IAsyncEdge<TNode, TEdge>
    {
        ...
        private readonly Func<TEdge, ValueTask<float>> getEdgeCostAsync;
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="DijkstraAsyncSearch{TNode, TEdge}"/> class.
        /// </summary>
        ...
        protected DijkstraAsyncSearch(Func<TNode, ValueTask<bool>> isTargetAsync, Func<TEdge, ValueTask<float>> getEdgeCostAsync)
        {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="DijkstraAsyncSearch{TNode, TEdge}"/> class,
        ...
        public static ValueTask<DijkstraAsyncSearch<TNode, TEdge>> CreateAsync(
            TNode source,
        ...
        /// <param name="cancellationToken">A cancellation token for the operation.</param>
        /// <returns>A <see cref="ValueTask" /> that will return the new search.</returns>
        public static async ValueTask<DijkstraAsyncSearch<TNode, TEdge>> CreateAsync(
            TNode source,
            Func<TNode, ValueTask<bool>> isTargetAsync,
            Func<TEdge, ValueTask<float>> getEdgeCostAsync,
            CancellationToken cancellationToken = default)
        {
            var search = new DijkstraAsyncSearch<TNode, TEdge>(isTargetAsync, getEdgeCostAsync);
        ...
        private async ValueTask VisitAsync(TNode node, float bestCost, CancellationToken cancellationToken)
        {
        ...
        private record struct FrontierNodeInfo(TEdge bestEdgeToNode, float bestCostToNode);
    }
}
#endif
