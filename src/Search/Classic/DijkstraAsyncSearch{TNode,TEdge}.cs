...
namespace SCGraphTheory.Search.Classic
{
        ...
        where TEdge : IAsyncEdge<TNode, TEdge>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DijkstraAsyncSearch{TNode, TEdge}"/> class.
        /// </summary>
        ...
        public DijkstraAsyncSearch(TNode source, Predicate<TNode> isTarget, Func<TEdge, float> getEdgeCost)
        {
            ...
            frontier.Enqueue(source, new (default, 0f));
