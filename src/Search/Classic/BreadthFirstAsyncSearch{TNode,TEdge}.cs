...
namespace SCGraphTheory.Search.Classic
{
        ...
        where TEdge : IAsyncEdge<TNode, TEdge>
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="BreadthFirstAsyncSearch{TNode, TEdge}"/> class.
        /// </summary>
        /// <param name="isTargetAsync">An async predicate for identifying the target node of the search.</param>
        protected BreadthFirstAsyncSearch(Func<TNode, ValueTask<bool>> isTargetAsync)
        {
