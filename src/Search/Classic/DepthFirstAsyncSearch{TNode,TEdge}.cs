...
namespace SCGraphTheory.Search.Classic
{
        ...
        where TEdge : IAsyncEdge<TNode, TEdge>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DepthFirstAsyncSearch{TNode, TEdge}"/> class.
        /// </summary>
        ...
        public DepthFirstAsyncSearch(TNode source, Predicate<TNode> isTarget)
        {
            ...
            frontier.Push(new (source, default));
