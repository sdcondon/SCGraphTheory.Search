...
namespace SCGraphTheory.Search.Classic
{
        ...
        where TEdge : IAsyncEdge<TNode, TEdge>
    {
        ...
        private readonly Func<TNode, ValueTask<float>> getEstimatedCostToTargetAsync;
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="AStarAsyncSearch{TNode, TEdge}"/> class,
        ...
        public static ValueTask<AStarAsyncSearch<TNode, TEdge>> CreateAsync(
            TNode source,
        ...
        /// <param name="cancellationToken">A cancellation token for the operation.</param>
        /// <returns>A <see cref="ValueTask" /> that will return the new search.</returns>
        public static async ValueTask<AStarAsyncSearch<TNode, TEdge>> CreateAsync(
            TNode source,
            Func<TNode, ValueTask<bool>> isTargetAsync,
            Func<TEdge, ValueTask<float>> getEdgeCostAsync,
            Func<TNode, ValueTask<float>> getEstimatedCostToTargetAsync,
