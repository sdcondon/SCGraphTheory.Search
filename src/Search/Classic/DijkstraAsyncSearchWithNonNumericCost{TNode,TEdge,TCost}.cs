...
namespace SCGraphTheory.Search.Classic
{
        ...
        where TCost : IComparable<TCost>, IComparisonOperators<TCost, TCost, bool>, IAdditionOperators<TCost, TCost, TCost>, IAdditiveIdentity<TCost, TCost>
  {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="DijkstraAsyncSearchWithNonNumericCost{TNode, TEdge, TCost}"/> class.
        /// </summary>
        ...
        protected DijkstraAsyncSearchWithNonNumericCost(Func<TNode, ValueTask<bool>> isTargetAsync, Func<TEdge, ValueTask<TCost>> getEdgeCostAsync)
        {
