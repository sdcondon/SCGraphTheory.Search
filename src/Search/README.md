...
See the [Specialized.AndOr namespace](https://github.com/sdcondon/SCGraphTheory.Search/tree/main/src/Search.TestGraphs/Specialized/AndOr) in the test graphs project for a couple of and-or graph examples.
